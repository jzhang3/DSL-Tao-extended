...
public class DslPatternsPackageImpl extends EPackageImpl implements DslPatternsPackage {
	 ...
	 * @generated
	 */
	public EReference getPattern_Explanation() {
	 ...
	 * @generated
	 */
	public EReference getExplanation_Authors() {
	 ...
	 * @generated
	 */
	public EReference getExplanation_Date() {
		return (EReference)explanationEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getExplanation_Version() {
		return (EReference)explanationEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getExplanation_Problem() {
		return (EReference)explanationEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getExplanation_Context() {
		return (EReference)explanationEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EReference getExplanation_Consequence() {
		return (EReference)explanationEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EAttribute getAspects_Content() {
	...
	public void createPackageContents() {
		...
		createEReference(patternEClass, PATTERN__EXPLANATION);
		...
		createEReference(explanationEClass, EXPLANATION__AUTHORS);
		createEReference(explanationEClass, EXPLANATION__DATE);
		createEReference(explanationEClass, EXPLANATION__VERSION);
		createEReference(explanationEClass, EXPLANATION__PROBLEM);
		createEReference(explanationEClass, EXPLANATION__CONTEXT);
		createEReference(explanationEClass, EXPLANATION__CONSEQUENCE);
		...
		createEAttribute(aspectsEClass, ASPECTS__CONTENT);
	...
	public void initializePackageContents() {
		...
		dateEClass.getESuperTypes().add(this.getAspects());
		authorsEClass.getESuperTypes().add(this.getAspects());
		versionEClass.getESuperTypes().add(this.getAspects());
		problemEClass.getESuperTypes().add(this.getAspects());
		contextEClass.getESuperTypes().add(this.getAspects());
		consequenceEClass.getESuperTypes().add(this.getAspects());
		...
		initEReference(getPattern_Explanation(), this.getExplanation(), null, "explanation", null, 0, 1, Pattern.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getExplanation_Authors(), this.getAuthors(), null, "authors", null, 0, 1, Explanation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getExplanation_Date(), this.getDate(), null, "date", null, 0, 1, Explanation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getExplanation_Version(), this.getVersion(), null, "version", null, 0, 1, Explanation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getExplanation_Problem(), this.getProblem(), null, "problem", null, 0, 1, Explanation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getExplanation_Context(), this.getContext(), null, "context", null, 0, 1, Explanation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getExplanation_Consequence(), this.getConsequence(), null, "consequence", null, 0, 1, Explanation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getAspects_Content(), ecorePackage.getEString(), "content", null, 0, 1, Aspects.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
